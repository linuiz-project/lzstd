...
//         match align {
//             Some(align) if address.is_aligned_to(align.as_u64()) => Some(Self(
//                 (address.as_u64() & !align.mask()) | align.depth(),
//                 PhantomData,
//             )),
...
//         match align {
//             Some(align) if ptr.is_aligned_to(align.as_usize()) => Some(Self(
//                 ((ptr.addr() as u64) & !align.mask()) | align.depth(),
//                 PhantomData,
//             )),

//             None => Some(Self(
//                 (ptr.addr() as u64) & !Self::ALIGN_BIT_MASK,
//                 PhantomData,
//             )),
...
//         self.align()
//             .map(|align| self.address().as_usize() / align.as_usize())
//     }
